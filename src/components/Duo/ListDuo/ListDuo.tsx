...
const ListDuo = () => {
  ...
  const { isListModal, toggleListModal } = useStore();
      ...
      <section>
        <div className={styles.wrapper}>
          ...
          <div className={styles.select_position}>
            <h2>Position 선택</h2>
            <InputRadio type="radio" id="Top" onChange={onFilterChange} name="position" value="Top" inLabelText="탑" />
            <InputRadio
              type="radio"
              id="Jug"
              onChange={onFilterChange}
      ...
      <section className={styles.section_card}>
        <div className={styles.div_card}>
          <ul className={styles.ul_card}>
            ...
            {isListModal && <CommonModal onClickModal={toggleListModal} inMessage="더 이상 존재하지 않습니다." />}
          </ul>
        </div>
      </section>
    </>
