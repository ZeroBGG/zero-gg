      ...
      <section className={styles.card}>
        <article className={styles.title}>
          <div className={styles.left}>
            <span className={styles['game-result']}>{myGame.win ? '승리' : '패배'}</span>
            <span className={styles['game-time']}>{gameDuration(gameData.gameDuration)}</span>
          </div>

          <div className={styles.right}>
            <span className={styles['game-type']}>솔랭</span>
        ...
        <article className={styles['game-stats']}>
          <div className={styles.champion}>
            <img
              src={`https://ddragon.leagueoflegends.com/cdn/13.1.1/img/champion/${myGame.championName}.png`}
